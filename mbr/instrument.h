...
void bx_instr_after_execution(unsigned cpu, bxInstruction_c *i, bx_address eip);
...
#define BX_INSTR_AFTER_EXECUTION(cpu_id, i, eip) bx_instr_after_execution(cpu_id, i, eip)
